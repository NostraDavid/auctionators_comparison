...
function Atr_Error_Handler(...)
    ...
    local funcnames = zc.printstack({
        silent = true
    })
    local funcstr = table.concat(funcnames, " > ")

    local looksLikeAuctionatorError = (zc.StringContains(msg, "auctionator.lua", "auctionatorQuery.lua",
        "auctionatorConflicts.lua", "auctionatorPane.lua", "auctionatorBuy.lua", "auctionatorConfig.lua",
        "auctionatorVendor.lua", "auctionator.xml", "auctionatorDatabase.lua", "auctionatorLocalize.lua",
        "auctionatorScan.lua", "auctionatorScanFull.lua", "auctionatorShop.lua", "auctionatorHints.lua", "zcutils"))
    ...
    if (looksLikeAuctionatorError) then
        ...
        Atr_LUA_ErrorMsg:SetText(msg .. "\n------------\nVERS:" .. AuctionatorVersion .. "   MEM:" ..
                                     Atr_GetAuctionatorMemString() .. "   DB:" .. Atr_GetDBsize() .. "   SE:" ..
                                     GetCVar("scripterrors") .. "  SL:" .. numShoppingLists .. "  DCP:" .. dcp ..
