...
function Atr_LocalizeFrames()
    ...
    while frame do
        ...
        local isAuctionatorFrame = (zc.StringStartsWith(fname, "Atr") or zc.StringStartsWith(fname, "Auctionator")) and
                                       zc.StringSame(pname, "UIParent")
...
local kUncutGems = {36924, -- sky sapphire
