function AtrBuildLTable_svSE()
    ...
    AtrL["Are you sure you want to create\nan auction with no buyout price?"] =
        "�r du s�ker p� att du vill skapa\nen auktion utan utk�pspris?"
    ...
    AtrL["Auctionator has yet to record any auctions for this item"] =
        "Auctionator har hittills inte sett en auktion f�r detta item."
    ...
    AtrL["Auctionator provided an auction module to LilSparky's Workshop."] =
        "Auctionator delgav LilSparky's Workshop en auktionsmodul"
    ...
    AtrL["No current auctions found\n\n(related auctions shown)"] =
        "Inga aktuella auktioner hittade\n\n(relaterade auktioner visade)"
