...
function Atr_BuildHints(itemName, itemLink)
    ...
    if (TUJMarketInfo) then
        ...
        Atr_AppendHint(results, tujData["marketaverage"],
            ZT("UnderMine Journal (average) standard deviation " .. stddev))
    end
...
function Atr_ShowTipWithPricing(tip, link, num)
    ...
    local vendorPrice, auctionPrice, dePrice = Atr_STWP_GetPrices(link, num, showStackPrices, itemVendorPrice, itemName,
        itemType, itemRarity, itemLevel)
