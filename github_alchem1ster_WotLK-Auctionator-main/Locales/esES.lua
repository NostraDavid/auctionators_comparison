function AtrBuildLTable_esES()
    ...
    AtrL["Configure how you typically like to sell the items listed below."] =
        "Configura como quieres vender los artículos listados a continuación"
    ...
    AtrL["Are you sure you want to create\nan auction with no buyout price?"] =
        "¿Está usted seguro de que quiere crear una subasta\nsin precio de venta?"
    ...
    AtrL["Auctionator has yet to record any auctions for this item"] =
        "Subastador aún tiene que registrar subastas para este artículo"
    AtrL["Auctionator provided an auction module to LilSparky's Workshop."] =
        "El Subastador provee un módulo de subastas para LilSparky's Workshop."
    ...
    AtrL["Automatically cancel all of your auctions|n|nthat are not the lowest priced?"] =
        "¿Cancelar automáticamente todas las subastas|n|nque no estén en el precio más bajo?"
    ...
    AtrL["No current auctions found\n\n(related auctions shown)"] =
        "Ninguna subasta actual encontrada\n\n(subastas relacionadas mostradas)"
    ...
    AtrL["Only include items in the scanning database that are this level or higher"] =
        "Sólo incluir artículos en la base de datos del escaner de este nivel o más alto"
    AtrL["Other"] = "Otro"
    ...
    AtrL["The latest information on Auctionator can be found at"] =
        "La última información sobre el Subastador puede ser encontrada en"
    AtrL["There is a more recent version of Auctionator: VERSION"] =
        "Existe una versión más reciente del Subastador: VERSIÓN"
